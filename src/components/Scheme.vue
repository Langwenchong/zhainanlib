  ...
  <div id="Scheme">
    <div class="main">
      <div class="navigation">
        <ul>
          <li @click="plan(0)">推荐</li>
          <li @click="plan(1)">关注</li>
          <li @click="plan(2)">最热</li>
          <li @click="plan(3)">应用推荐</li>
          <li @click="plan(4)">生活方式</li>
          <li @click="plan(5)">操作技巧</li>
          <li @click="plan(6)">播客</li>
        </ul>
      </div>
      <div class="window">
        <transition>
